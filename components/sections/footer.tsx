          ...
          <div className="grid gap-8 lg:grid-cols-[1.1fr_0.9fr]">
            ...
            <div className="grid gap-6 sm:grid-cols-2">
              ...
              <div>
                ...
                <div className="mt-4 space-y-3">
                  <a href={`mailto:${siteConfig.email}`} className="flex items-center gap-2 text-slate-200 transition-colors hover:text-white">
                    <Mail className="w-4 h-4 text-slate-500" />
                    Email
                  </a>
                  <a href={siteConfig.github} target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-slate-200 transition-colors hover:text-white">
                    <Github className="w-4 h-4 text-slate-500" />
                    GitHub
                  </a>
                  <a href={siteConfig.linkedin} target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-slate-200 transition-colors hover:text-white">
